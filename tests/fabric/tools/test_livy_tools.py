...
class TestLivyTools:
    def test_livy_tools_smoke(self):
        ...
        assert (
            tools["livy_create_session"](workspace_id="ws-1", lakehouse_id="lh-1")["id"]
            == "1"
        )
        assert (
            tools["livy_list_sessions"](workspace_id="ws-1", lakehouse_id="lh-1")[
                "sessions"
            ][0]["id"]
            == "1"
        )
        assert (
            tools["livy_get_session_status"](
                workspace_id="ws-1", lakehouse_id="lh-1", session_id="1"
            )["state"]
            == "idle"
        )
        assert (
            tools["livy_close_session"](
                workspace_id="ws-1", lakehouse_id="lh-1", session_id="1"
            )["msg"]
            == "closed"
        )
