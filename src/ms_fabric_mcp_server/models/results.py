...
class UpdateNotebookResult(FabricOperationResult):
    ...
    notebook_name: Optional[str] = Field(
        default=None, description="Display name of the notebook"
    )
    workspace_id: Optional[str] = Field(
        default=None, description="Workspace ID containing the notebook"
    )
...
class ExecuteNotebookResult(FabricOperationResult):
    ...
    job_instance_id: Optional[str] = Field(
        default=None, description="UUID of the notebook-run instance"
    )
    item_id: Optional[str] = Field(
        default=None, description="UUID of the notebook item"
    )
    job_type: Optional[str] = Field(default=None, description="Type of job")
    invoke_type: Optional[str] = Field(
        default=None, description="How the job was invoked"
    )
    job_status: Optional[str] = Field(default=None, description="Current job status")
    root_activity_id: Optional[str] = Field(
        default=None, description="Root activity ID"
    )
    start_time_utc: Optional[str] = Field(
        default=None, description="Job start time in UTC"
    )
    end_time_utc: Optional[str] = Field(default=None, description="Job end time in UTC")
    failure_reason: Optional[Dict[str, Any]] = Field(
        default=None, description="Error details when job failed"
    )

    # Legacy fields for backward compatibility
    final_state: Optional[str] = Field(
        default=None, description="Deprecated: use job_status instead"
    )
    started_utc: Optional[str] = Field(
        default=None, description="Deprecated: use start_time_utc instead"
    )
    finished_utc: Optional[str] = Field(
        default=None, description="Deprecated: use end_time_utc instead"
    )
...
class RunJobRequest(BaseModel):
    ...
    execution_data: Optional[Dict[str, Any]] = Field(
        default=None, description="Payload for run on-demand job request"
    )
...
class RunJobResult(FabricOperationResult):
    ...
    job_instance_id: Optional[str] = Field(
        default=None, description="ID of the created job instance"
    )
    location_url: Optional[str] = Field(
        default=None, description="Location URL to poll for job status"
    )
    retry_after: Optional[int] = Field(
        default=None, description="Suggested retry interval in seconds"
    )
...
class JobStatusResult(FabricOperationResult):
    ...
    job: Optional[FabricJob] = Field(
        default=None, description="Job details and current status"
    )
    job_instance_id: Optional[str] = Field(
        default=None, description="ID of the job instance"
    )
    location_url: Optional[str] = Field(
        default=None, description="Location URL to poll for job status"
    )
