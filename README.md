...
The server provides **26 core tools**, with **3 additional SQL tools** when installed with `[sql]` extras (29 total).
...
If `pyodbc` is not available, the server starts with 26 tools (SQL tools disabled).
